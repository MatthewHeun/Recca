...
| Matrix                                              | Description                                                     |
+====================================================:+:================================================================+
| $\eta_p = (\mathbf{Yi}) /                           | Final demand product (rows) divided by embodied primary         |
| (\mathbf{iG}_{primary})^{\mathrm{T}}$               | energy of that final demand product                             |
+-----------------------------------------------------+-----------------------------------------------------------------+
| $\eta_s = [\mathbf{iY} /                            | Energy consumed by final demand sector (rows) divided by        |
| (\mathbf{iH}_{primary})^{\mathrm{T}}]^{\mathrm{T}}$ | embodied energy input to the final demand sector                |
+-----------------------------------------------------+-----------------------------------------------------------------+
