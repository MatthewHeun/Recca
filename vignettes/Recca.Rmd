...
| \mathbf{G}_V + \mathbf{G}_R$         | demand ($(r + i) \times p$)                                     |
+--------------------------------------+-----------------------------------------------------------------+
...
| \mathbf{H}_V + \mathbf{H}_R$         | demand sectors ($(r + i) \times s$)                             |
+--------------------------------------+-----------------------------------------------------------------+
...
| \mathbf{r})}^{-1}$                   |                                                                 |
+--------------------------------------+-----------------------------------------------------------------+
| $\mathbf{M}_p$                       | Shows embodied energy products in each embodying energy product |
|                                      | (embodied products $\times$ embodying products)                 |
+--------------------------------------+-----------------------------------------------------------------+
| $\mathbf{M}_s$                       | Shows embodied energy products consumed by final demand sectors |
|                                      | (embodied products $\times$ consuming final demand sectors      |
+--------------------------------------+-----------------------------------------------------------------+
...
|                            | On a fractional basis, where does that embodied energy come     |
|                            | from (rows)? Columns sum to 1.                                  |
+----------------------------+-----------------------------------------------------------------+
| $\mathbf{F}_{ef\!fects,p}$ | Each upstream energy product (rows) becomes embodied somewhere. |
|                            | On a fractional basis, where does that upstream energy become   |
|                            | embodied (columns)? Rows sums to 1.                             |
+----------------------------+-----------------------------------------------------------------+
| $\mathbf{F}_{footprint,s}$ | Each final demand sector (columns) consumes embodied energy. On |
|                            | a fractional basis, where does the consumed embodied energy     |
|                            | come from (rows)? Columns sum to 1.                             |
+----------------------------+-----------------------------------------------------------------+
| $\mathbf{F}_{ef\!fects,s}$ | Each embodied upstream energy product (rows) is consumed by a   |
|                            | final demand sector. On a fractional basis, where is that       |
|                            | embodied upstream energy consumed (columns)? Rows sums to 1.    |
+----------------------------+-----------------------------------------------------------------+
...
| Matrix   | Description                                                     |
+=========:+:================================================================+
| $\eta_p$ | Final demand product (rows) divided by embodied energy of that  |
|          | final demand product                                            |
+----------+-----------------------------------------------------------------+
| $\eta_s$ | Energy consumed by final demand sector (rows) divided by        |
|          | embodied energy input to the final demand sector                |
+----------+-----------------------------------------------------------------+
