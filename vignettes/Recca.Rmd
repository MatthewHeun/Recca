...
## PSUT matrix construction (2.2.2)
...
The `AsMats` data frame is essentially the same as the `UKEnergy2000mats` data frame
that is available in the `Recca` package.
Te rest of this vignette uses the `UKEnergy2000mats` data frame.
