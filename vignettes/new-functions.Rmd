...
After some background information, each type of analysis is described in turn.


## Background

For the examples that follow, we'll use the `UKEnergy2000mats` data frame from the `Recca` package.
Each `new_*` function requires basic knowledge about the I-O structure of the ECC.
The simplest way to obtain that information 
