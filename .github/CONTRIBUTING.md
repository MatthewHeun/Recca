...
# Contributing to `Recca`

This document outlines how to propose a change to the `Recca` package.
...
* New code should be written in a style that matches the rest of the code in `Recca`. 
